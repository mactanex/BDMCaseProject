...
#    | {1,Mechanical,2,4},{2,Software,4,6}                                         |  {1,Mechanical,3,4},{2,Software,4,6}                                          | Satisfied     |
#    | {1,Mechanical,2,4},{2,Software,4,2}                                         |  {1,Mechanical,3,6},{1,Software,4}                                            | Satisfied     |
#    | {1,Mechanical,2,22}                                                          |  {1,Mechanical,3,16},{2,Mechanical,4,14}                                        | Satisfied     |
#    | {1,Mechanical,2,7}                                                          |  {1,Mechanical,3,6},{2,Mechanical,4,3}                                        | Satisfied     |
...
#    | {1,Mechanical,2,4},{2,Software,4,6},{3,Mechanical,2,4},{4,Software,4,6}     |  {1,Mechanical,3,4},{2,Software,4,6}                                          | Not satisfied |
