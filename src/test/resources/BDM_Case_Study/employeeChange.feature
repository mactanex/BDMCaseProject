...
Scenario: Refresh available time units
    Given An employee with a unique id 1 and 6 available time units exist.
    When The employee has been scheduled for a job and the employee's time units are 0.
    When The system starts a new day.
    Then The employee has refreshed his 6 time units.
